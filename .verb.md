...
--- | --- | --- | ---
front-matter parsing | No | Yes | use [assemble](https://github.com/assemble/assemble) or use [parser-front-matter][] as an `.onLoad` middleware. 
...
Built-in template engine | No | Yes | [assemble](https://github.com/assemble/assemble) ships with [engine-handlebars][]. Use `.engine()` to register any [consolidate][]-compatible template engine. 
