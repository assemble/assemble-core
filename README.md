...
Assemble v0.6.0 has full [vinyl-fs][] support, so any [gulp](http://gulpjs.com) plugin should work with assemble.
...
[vinyl-fs]: http://github.com/wearefractal/vinyl-fs[assemble-fs]: https://github.com/jonschlinkert/assemble-fs[assemble-render-file]: https://github.com/jonschlinkert/assemble-render-file[assemble-streams]: https://github.com/jonschlinkert/assemble-streams[base-tasks]: https://github.com/jonschlinkert/base-tasks[lazy-cache]: https://github.com/jonschlinkert/lazy-cache[templates]: https://github.com/jonschlinkert/templates